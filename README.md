...
This project is an end-to-end pipeline I built to collect, store, and analyze YouTube channel performance data.  
The goal was to create a real-world example of how data engineering and data analysis can be combined to generate meaningful insights for a content creator.
